 ...
 * @param[state] The [DragSelectState] to toggle the selection state of the item in.
...
public fun <Item> Modifier.dragSelectToggleableItem(
    ...
    Modifier
        .dragSelectSemantics(state, item, semanticsLabel)
        .dragSelectToggleable(state, item, interactionSource)
)