...
dependencies {
    ...
    implementation("com.dragselectcompose:dragselect:2.4.3")

    // Or use the modules you want

    // Core functionality
    implementation("com.dragselectcompose:core:2.4.3")

    // Optional extensions for adding semantics and toggle Modifiers to Grid items
    implementation("com.dragselectcompose:extensions:2.4.3")

    // Optional wrappers around LazyGrid that implement the selection UI for you
    implementation("com.dragselectcompose:grid:2.4.3")
}
```
