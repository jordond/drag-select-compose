...
dependencies {
    ...
    implementation("com.dragselectcompose:dragselect:2.3.2")

    // Or use the modules you want

    // Core functionality
    implementation("com.dragselectcompose:core:2.3.2")

    // Optional extensions for adding semantics and toggle Modifiers to Grid items
    implementation("com.dragselectcompose:extensions:2.3.2")

    // Optional wrappers around LazyGrid that implement the selection UI for you
    implementation("com.dragselectcompose:grid:2.3.2")
}
```
